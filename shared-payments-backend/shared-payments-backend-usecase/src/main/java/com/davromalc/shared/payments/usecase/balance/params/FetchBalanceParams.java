package com.davromalc.shared.payments.usecase.balance.params;
...
public final class FetchBalanceParams implements UseCaseParams {

  private final Long userId;

  public FetchBalanceParams(Long userId) {
    this.userId = userId;
  }
  ...
  public boolean equals(Object o) {
    ...
    FetchBalanceParams that = (FetchBalanceParams) o;
